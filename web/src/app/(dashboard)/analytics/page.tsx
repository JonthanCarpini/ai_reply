              ...
              <Card className="border-slate-800 bg-slate-900">
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={250}>
                    <PieChart>
                      <Pie data={actionStats!.by_type.map((a) => ({ name: actionTypeLabels[a.action_type] || a.action_type, value: a.total }))} cx="50%" cy="50%" outerRadius={80} dataKey="value" label={({ name, percent }) => `${name} ${(percent * 100).toFixed(0)}%`}>
